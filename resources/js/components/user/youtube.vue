				...
				<div class="col-sm-9 padding-right">
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="images/product-details/ytb_png.png" alt="" />
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p><b>Taille par rapport aux followers: </b>{{getOnePersonne[0].youtube.followers}}</p>
								<p><b>Qualité d’audience: </b>{{getOnePersonne[0].youtube.qualite}}</p>
								<p><b>Engagement: </b>{{getOnePersonne[0].youtube.engagement}}</p>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						...
						<div class="tab-content">
							<div class="tab-pane fade active in" id="tag" v-for="(c,i) in getOnePersonne[0].youtube.domaine" :key="i">
